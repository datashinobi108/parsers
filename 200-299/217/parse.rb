...
categories = ['Asia & the Pacific', 'Europe', 'Africa', 'Latin America & the Caribbean', 'Oceania', 'North America', 'World']

header_country_code="iso_code"
header_country="country"
header_value="total_vaccinations_per_hundred"
header_date="date"
header_url="url"
